...
export default function BackgroundAnimations() {
  ...
  return (
    <div style={{ position: 'fixed', top: 0, left: 0, width: '100vw', height: '100vh', zIndex: -1, pointerEvents: 'none', overflow: 'hidden' }}>
      ...
      <div style={{ position: 'absolute', top: 0, left: '5%', width: '1px', height: '140%', background: 'linear-gradient(to bottom, transparent, var(--line-color), transparent)', transform: 'rotate(15deg)', transformOrigin: 'top left', animation: 'smoothFadeIn 2s ease-out 0.5s both' }}></div>
      <div style={{ position: 'absolute', top: 0, right: '8%', width: '1px', height: '140%', background: 'linear-gradient(to bottom, transparent, var(--line-color), transparent)', transform: 'rotate(-12deg)', transformOrigin: 'top right', animation: 'smoothFadeIn 2s ease-out 0.8s both' }}></div>
